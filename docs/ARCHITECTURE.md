...
Pas de CMS ni de base : hébergements, événements, textes région, etc. sont dans les composants et les fichiers de traduction. Config globale dans `src/lib/data/site.ts` (placeholders téléphone, adresse, URL).
